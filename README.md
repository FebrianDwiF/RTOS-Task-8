...
### Prasyarat
1. STM32CubeMX (untuk konfigurasi mikrokontroler).
2. STM32CubeIDE (untuk pengembangan dan pengujian).
3. Board STM32 yang sesuai.
4. USB to Serial Adapter (untuk komunikasi UART, jika diperlukan).
...
2. **Buka STM32CubeIDE** dan buat proyek STM32 baru dengan memilih mikrokontroler yang sesuai.

3. **Konfigurasi GPIO**:
   - Setel pin GPIO untuk LED (misalnya, `LED1_Pin`, `LED2_Pin`, dll.) sebagai output.
   - Aktifkan UART1 jika ingin menggunakan komunikasi serial untuk debugging.
